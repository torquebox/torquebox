...
public class NonLeakingLoadService19 extends LoadService19 {

    public NonLeakingLoadService19(Ruby runtime) {
        super( runtime );
    }
    ...
    protected LoadServiceResource wrapLeakingResource(LoadServiceResource resource) {
        return NonLeakingLoadService.wrapLeakingResource( resource );
    }
