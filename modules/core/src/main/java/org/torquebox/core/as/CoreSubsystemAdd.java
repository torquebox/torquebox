...
class CoreSubsystemAdd implements ModelAddOperationHandler, BootOperationHandler {
    ...
    protected void addDeploymentProcessors(final BootOperationContext context) {
        ...
        context.addDeploymentProcessor( Phase.PARSE, 1, new TorqueBoxYamlParsingProcessor() );
        context.addDeploymentProcessor( Phase.PARSE, 2, new EnvironmentYamlParsingProcessor() );
