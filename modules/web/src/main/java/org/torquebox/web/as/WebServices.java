...
public class WebServices {
    ...
    public static final ServiceName MOD_CLUSTER_UUID_FIX = WEB.append( "mod_cluster_uuid_fix" );
    public static final ServiceName MOD_CLUSTER_KEY_FIX  = WEB.append( "mod_cluster_key_fix" );
