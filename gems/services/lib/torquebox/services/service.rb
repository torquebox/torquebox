  ...
  module Services
    ...
    class Service
      class << self
        ...
        #   of RubyService instances - see {TorqueBox::Services::Service.lookup}
        ...
        #   {TorqueBox::Services::Service.list} methods are not instances of this
        ...
        #   service = TorqueBox::Services::Service.lookup('my_service')
